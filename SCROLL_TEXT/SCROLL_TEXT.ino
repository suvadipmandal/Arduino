...
#define BC {B01111000,B10000000,B10000000,B10000000,B10000000,B01111000}
...
#define NUM4{B00011000,B00101000,B01001000,B11111100,B00001000,B00001000}
#define NUM5{B11111000,B10000000,B11110000,B00001000,B10001000,B01110000}
#define NUM6{B01111000,B10000000,B11110000,B10001000,B10001000,B01110000}
#define NUM7{B11111000,B00010000,B00100000,B01100000,B00100000,B00100000}
#define NUM8{B01110000,B10001000,B11111000,B10001000,B10001000,B01110000}
#define NUM9{B01110000,B10001000,B10001000,B01111000,B10001000,B01110000}
...
#define LDOT{B00000000,B00100000,B01010000,B01010000,B00100000,B00000000}
#define BDOT{B00000000,B01110000,B11011000,B11011000,B01110000,B00000000}
#define ARROW{B00011000,B00110000,B01100000,B01100000,B00110000,B00011000}
...
int array_turn=0;
byte your_text[300][6]={BW,LI,LS,LH,LI,LN,LG,SPACE,BY,LO,LU,SPACE,BA,SPACE,BH,LA,LP,LP,LY,SPACE,BD,LI,LW,LA,LL,LI,SPACE,BG,LL,LO,LW,LI,LN,LG,SPACE,BW,LI,LT,LH,SPACE,BP,LE,LA,LC,LE,COMA,BJ,LO,LY,COMA,BA,LN,LD,SPACE,BP,LR,LO,LS,LP,LE,LR,LI,LT,LY,SPACE,MARK,TWODOTS,TWODOTS,BC,BL,BR,BE,BA,BT,BE,BD,SPACE,BB,BY,SPACE,LINE,BS,BU,BV,BA,BD,BI,BP,SPACE,BM,BA,BN,BD,BA,BL,SPACE,BC,BS,BE,SPACE,NUM3,BR,BD,SPACE,BY,BE,BA,BR,SPACE,BA,BT,BC,BO,BO,BC,BH,SPACE,BB,BE,BH,BA,BR,SPACE,BG,BO,BV,DOT,SPACE,BE,BN,BG,BI,BN,BE,BE,BR,BI,BN,BG,SPACE,BC,BO,BL,BL,BA,BG,BE,TWODOTS,TWODOTS,LINE,LINE,LINE,LINE,LINE,LINE,SPACE,BW,BI,BS,BH,SPACE,BY,BO,BU,SPACE,BA,BD,BV,BA,BN,BC,BE,SPACE,BH,BA,BP,BP,BY,SPACE,BN,BE,BW,SPACE,BY,BE,BA,BR,SPACE,NUM2,NUM0,NUM1,NUM9,MARK,MARK,MARK,MARK,BE,LINE,LM,LA,LI,LL,SPACE,TWODOTS,LINE,LS,LU,LS,LU,LV,LA,LV,LI,LP,DOT,LM,LA,LN,LD,LA,LL,LDOT,LH,LO,LT,LM,LA,LI,LL,DOT,LC,LC,LM,SPACE,BW,BH,BA,BT,BS,BA,BP,BP,BS,SPACE,TWODOTS,LINE,NUM7,NUM6,NUM7,NUM9,NUM1,NUM0,NUM7,NUM2,NUM4,NUM7,SPACE,COMA,SPACE,BC,BO,BN,BT,BA,BC,BT,SPACE,TWODOTS,LINE,SPACE,NUM8,NUM9,NUM1,NUM8,NUM8,NUM1,NUM7,NUM4,NUM6,NUM2,DOT };//PUT YOU TEXT HERE
...
byte make_word (long posistion,byte turn){
  ...
  void loop() {
        ...
        display_word(1,your_text,300,20);// calls for the display_pattern function and says that int loop = 15(if you do more loop the pattern whould scrole slower).
